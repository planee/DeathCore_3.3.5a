...
int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.authserver", "       ____             __  __    ______");              
	TC_LOG_INFO("server.authserver", "	    / __ \___  ____ _/ /_/ /_  / ____/___  ________"); 
	TC_LOG_INFO("server.authserver", "	   / / / / _ \/ __ `/ __/ __ \/ /   / __ \/ ___/ _ \ ");
	TC_LOG_INFO("server.authserver", "    / /_/ /  __/ /_/ / /_/ / / / /___/ /_/ / /  /  __/");
	TC_LOG_INFO("server.authserver", "   /_____/\___/\__,_/\__/_/ /_/\____/\____/_/   \___/"); 
    TC_LOG_INFO("server.authserver", "                                 3.3.5A  ");
