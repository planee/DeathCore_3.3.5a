...
extern int main(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "       ____             __  __    ______");              
	TC_LOG_INFO("server.worldserver", "	     / __ \___  ____ _/ /_/ /_  / ____/___  ________"); 
	TC_LOG_INFO("server.worldserver", "	    / / / / _ \/ __ `/ __/ __ \/ /   / __ \/ ___/ _ \ ");
	TC_LOG_INFO("server.worldserver", "    / /_/ /  __/ /_/ / /_/ / / / /___/ /_/ / /  /  __/");
	TC_LOG_INFO("server.worldserver", "   /_____/\___/\__,_/\__/_/ /_/\____/\____/_/   \___/"); 
    TC_LOG_INFO("server.worldserver", "                                 3.3.5A  ");
